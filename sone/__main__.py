	...
	async with httpx.AsyncClient() as client:
		while True:
			try:
				...
				logger.error(
					"Invalid server response for websocket, check Cloud URL and networking. Retrying in 5 seconds.")
...
def device(cloud_url=None, host: str = LOCAL_HOST, port: int = LOCAL_PORT):
	...
	# Class variables are initialised on import. The cloud application does not require these hardware modules.
